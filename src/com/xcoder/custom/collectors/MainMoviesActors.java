package com.xcoder.custom.collectors;

import com.xcoder.model.Actor;
import com.xcoder.model.Movie;
...
public class MainMoviesActors {
    ...
    public static void main(String... args) throws IOException {
        ...
        Stream<String> lines
                = Files.lines(
                Paths.get("maps-and-flatmap/files", "movies-mpaa.txt")
        );
...
//                .map(movie -> movie.actors().stream()) // Stream<Stream<Actors>>
        ...
        System.out.println("Most viewed Actors: " + mostViewedActor);

        // actor that played in the greatest number of movies during a year
        // Map<release year, Map<Actors, # of movies that year>>
